...
def zero_percent_no_finetuning():
    ...
    if args.model_type == "shebert":
        ...
        config = BertConfig.from_pretrained("../models/crosloengual-bert-pytorch/bert_config.json", num_labels=len(label_set))
        model = BertForSequenceClassification.from_pretrained("../models/crosloengual-bert-pytorch/pytorch_model.bin", config=config)
